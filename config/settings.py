"""
FinFlow - Конфигурация Django приложения
Автоматизированный финансовый ассистент для малого бизнеса
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'finflow'),
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'finflow.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
